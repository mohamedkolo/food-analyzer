...
def _find_font(filename):
    candidates = [
        ...
        f"/usr/share/fonts/opentype/fonts-hosny-amiri/{filename}",
        f"/usr/share/fonts/truetype/amiri/{filename}",
    ...
    raise FileNotFoundError(
        f"Font '{filename}' not found. Please upload it to GitHub alongside app.py"
    )

FONT_REG  = _find_font("Amiri-Regular.ttf")
FONT_BOLD = _find_font("Amiri-Bold.ttf")

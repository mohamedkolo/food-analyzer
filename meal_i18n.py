...
WORDS = {
    ...
    # ‏فطار الحالات المقيّدة
    "بالكوسة": "with zucchini", "ذرة": "corn", "رقاق أرز": "rice cakes",
    "رقاق": "cakes", "عين جمل": "walnuts", "كمثرى": "pear",
    # ‏العبارة قبل الكلمة: "سردين مصفّى" لوحدها بتطلع "sardines drained"،
    # و"ملعقة صغيرة" بتطلع "small ... tbsp" لأن الترتيب بيقدّم الصفة.
    # المعجم مرتّب بالأطول الأول، فالعبارة بتكسب على الكلمة.
